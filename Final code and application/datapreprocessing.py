...
def wordnet_fun(df_copy,no_of_tweets):
    ...
    for i in range(len(df_copy.index)):
        ...
        stop_words={"wasn't", 'ours', 'were', 'be', 'needn', "aren't", 'against', "weren't", 'than', 'over', 'no', 'yourselves', 'her', 'down', 'most', 'just', 'hadn', 'but', 'was', 'ain', 'aren', 'few', 'am', 'from', 'about', 'yours', 'through', 'shouldn', 'ourselves', "hasn't", 'does', "you'll", 'of', 'weren', 'same', 'haven', "you're", "couldn't", 'whom', 'm', "shan't", 'his', 'or', 'did', 'why', "hadn't", 'ma', 'that', 'you', 'y', 'do', 'themselves', 'out', 'are', 'then', 'your', 'she', 'more', 'he', 'until', 'above', 'my', "needn't", 'i', 'doing', 'here', 'who', 'me', 'a', 'if', 'each', 'both', 'the', 'been', 'll', 'didn', 'wasn', 'further', 'where', 'isn', 'into', "that'll", 'because', 're', 'mustn', 'off', 'what', 'which', 'had', 'for', 'with', 'him', "haven't", 'have', 's', "don't", 'wouldn', 'at', 't', 'and', "won't", 'some', 'our', 'itself', 'on', 'those', 'again', 'in', 'only', 'up', 'don', "didn't", 'these', 'them', 'theirs', 've', 'such', "you've", 'will', 'nor', 'is', 'o', 'this', 'while', "it's", 'they', 'hasn', 'any', 'should', 'has', 'an', 'yourself', "wouldn't", 'their', 'd', 'to', 'after', 'having', 'so', 'very', 'can', "she's", "mightn't", 'all', 'won', 'below', 'couldn', 'hers', 'herself', 'how', 'we', "should've", 'shan', "shouldn't", 'myself', 'during', 'being', 'there', 'its', 'doesn', "you'd", 'when', 'now', 'not', 'own', 'himself', 'as', 'mightn', "doesn't", "mustn't", 'between', 'other', 'by', 'too', "isn't", 'before', 'it', 'under', 'once'}
